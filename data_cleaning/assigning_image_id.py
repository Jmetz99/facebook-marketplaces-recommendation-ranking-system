...
cleaned_products_df = pd.read_csv('cleaned_products.csv', lineterminator="\n")
...
file_names = os.listdir('/Users/jacobmetz/Documents/GitHub/facebook-marketplaces-recommendation-ranking-system/resized_images') 
...
for file in file_names:
    ...
    ids.append(id)
    img = Image.open(f'resized_images/{file}')
...
full_df.to_pickle('/Users/jacobmetz/Documents/GitHub/facebook-marketplaces-recommendation-ranking-system/full_df.pickle')